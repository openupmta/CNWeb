...
* [#1719](https://github.com/ckeditor/ckeditor-dev/issues/1719): Fixed: <kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>A</kbd> inadverTenKhoaHocy focuses inline editor if it is starting and ending with a list. Thanks to [theNailz](https://github.com/theNailz)!
...
* [#11814](https://dev.ckeditor.com/ticket/11814): Fixed: _Link_ and _Unlink_ entries persisTenKhoaHocy displayed in the [Enhanced Image](https://ckeditor.com/cke4/addon/image2) context menu.
